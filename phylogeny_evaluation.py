...
"""phylogeny_evaluation.py
    Usage:
        phylogeny_evaluation.py -i <DIR> -o <DIR> -g <FILE> -c <FILE> [-t <FILE>]
        phylogeny_evaluation.py -i <DIR> -o <DIR> -g <FILE> -c <FILE> --trees <STR> --trees_suffix <STR> [-t <FILE>]
...
from depot.PetIO import check_programs, check_indir, get_outdir, progress, fix_iqtree, run_fasttree, run_iqtree
